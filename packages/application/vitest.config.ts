    ...
    alias: [
      {
        ...
        replacement: path.resolve(__dirname, "../remote-domain/src/remote-domain.contracts.ts"),
      },
      {
      ...
      },
      {
        ...
        replacement: path.resolve(__dirname, "../remote-domain/src/remote-domain.port.ts"),
      },
      {
