...
export const SETTINGS_PERMISSION_DEFINITIONS = [
  ...
  { key: "rotinas_mensais:view", label: "Visualizar rotinas mensais do proprio escopo", module: "rotinas_mensais", description: "Permite consultar a rotina mensal das empresas vinculadas ao proprio escopo." },
  ...
  { key: "rotinas_mensais:manage", label: "Gerenciar rotinas mensais", module: "rotinas_mensais", description: "Permite configurar regras, contatos e operar o modulo de rotinas mensais." },
