...
export const SETTINGS_PERMISSION_DEFINITIONS = [
  ...
  { key: "tarefas:view", label: "Visualizar tarefas do proprio escopo", module: "tarefas", description: "Permite consultar tarefas e rotinas mensais das empresas vinculadas ao proprio escopo." },
  { key: "tarefas:view_all", label: "Visualizar todas as tarefas", module: "tarefas", description: "Libera visao global do modulo de tarefas." },
  { key: "tarefas:manage", label: "Gerenciar tarefas", module: "tarefas", description: "Permite criar, configurar e operar o modulo de tarefas e rotinas mensais." },
  { key: "rotinas_mensais:view", label: "Visualizar rotinas mensais do proprio escopo", module: "rotinas_mensais", description: "Permite consultar rotinas mensais das empresas vinculadas ao proprio escopo." },
  { key: "rotinas_mensais:view_all", label: "Visualizar todas as rotinas mensais", module: "rotinas_mensais", description: "Libera visao global do modulo de rotinas mensais." },
  { key: "rotinas_mensais:manage", label: "Gerenciar rotinas mensais", module: "rotinas_mensais", description: "Permite configurar e operar o modulo de rotinas mensais." },
