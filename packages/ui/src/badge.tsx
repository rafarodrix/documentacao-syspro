  ...
  "inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        info: "border-transparent bg-purple-500/15 text-purple-700 dark:text-purple-300 hover:bg-purple-500/25",
        muted: "border-transparent bg-zinc-500/15 text-zinc-600 dark:text-zinc-400 hover:bg-zinc-500/25"
      }
    },
    defaultVariants: {
      variant: "default"
