    ...
    <Link href={item.href} className="group block animate-docs-fade-up opacity-0" style={style}>
      <MagicCard className="h-full rounded-2xl">
        <div className="relative h-full rounded-2xl border border-border/70 bg-card/70 p-4 transition-colors sm:p-5 group-hover:bg-card">
          <div className={cn('pointer-events-none absolute inset-0 rounded-2xl bg-linear-to-br to-transparent opacity-20', tone.glowClass)} />
    ...
    <div className="space-y-10 pb-12">
      <section className="relative animate-docs-fade-up overflow-hidden rounded-2xl border border-border/60 bg-[linear-gradient(180deg,rgba(255,255,255,0.02),rgba(255,255,255,0))] bg-card p-5 opacity-0 md:p-6" style={staggerStyle(0)}>
        ...
        <div className="flex flex-wrap items-center gap-3">
          <LargeSearchToggle className="h-11 min-w-65 flex-1 justify-start rounded-xl border-border/70 bg-background/85 text-sm" />
        </div>
