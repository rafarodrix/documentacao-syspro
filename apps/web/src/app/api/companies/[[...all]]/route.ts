...
async function proxyCompanies(request: NextRequest, context: CatchAllRouteContext): Promise<Response> {
  return proxyToBackend(request, {
    path: await resolveCatchAllBackendPath(context, "/companies"),
  });
}
