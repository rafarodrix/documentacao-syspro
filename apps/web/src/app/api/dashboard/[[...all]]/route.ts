...
async function proxyDashboard(request: NextRequest, context: CatchAllRouteContext): Promise<Response> {
  return proxyToBackend(request, {
    path: await resolveCatchAllBackendPath(context, "/dashboard"),
  });
}
