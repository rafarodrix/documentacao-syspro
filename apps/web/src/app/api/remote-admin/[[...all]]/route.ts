...
async function proxyRemoteAdmin(request: NextRequest, context: CatchAllRouteContext): Promise<Response> {
  return proxyToBackend(request, {
    path: await resolveCatchAllBackendPath(context, "/remote-admin"),
  });
}
