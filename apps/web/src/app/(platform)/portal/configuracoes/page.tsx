...
const TAB_VALUES = new Set(["general", "access", "tax", "contracts", "sefaz", "observability", "remote-access"]);
            ...
            <Tabs defaultValue={defaultTab} className="space-y-6">
                <div className="flex items-center">
                    <TabsList className="bg-muted/50 p-1 border border-border/40 h-auto flex-wrap">
                        ...
                        <TabsTrigger value="remote-access" className="gap-2 px-6 py-2 data-[state=active]:bg-background data-[state=active]:shadow-sm transition-colors">
                ...
                <TabsContent value="remote-access" className="space-y-4 focus-visible:ring-0 outline-none animate-in fade-in zoom-in-95 duration-300">
                    <div className="max-w-6xl">
