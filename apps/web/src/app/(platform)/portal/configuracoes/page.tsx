        ...
        <div className="flex flex-col gap-8 p-6 max-w-7xl mx-auto w-full animate-in fade-in slide-in-from-bottom-4 duration-700 pb-20">
            <div className="flex flex-col gap-2 border-b border-border/40 pb-6">
                ...
                <p className="text-muted-foreground text-lg max-w-2xl">
                    Gerencie parâmetros globais do sistema. A aba Agente Trilink cobre a governança global dos módulos do agente; a operação de hosts, sessões, relatórios e dispositivos continua em Infraestrutura.
                </p>
            </div>
