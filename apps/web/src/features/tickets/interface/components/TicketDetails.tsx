...
const DETAIL_ALLOWED_HTML_TAGS = new Set([
    "a",
    "b",
    "blockquote",
    "br",
...
const DETAIL_TAG_ALLOWED_ATTRIBUTES: Record<string, Set<string>> = {
...
function sanitizeDetailHtml(html: string) {
    ...
    const sanitizeNode = (node: Node) => {
        if (node.nodeType === Node.ELEMENT_NODE) {
            ...
            if (!DETAIL_ALLOWED_HTML_TAGS.has(tagName)) {
            ...
            const allowedAttributes = new Set([
                ...(DETAIL_TAG_ALLOWED_ATTRIBUTES[tagName] ?? new Set<string>()),
            ]);
            ...
            for (const attribute of Array.from(element.attributes)) {
                ...
                if ((attributeName === "href" || attributeName === "src") && !isSafeDetailUrl(attributeValue)) {
                    element.removeAttribute(attribute.name);
                    continue;
                }
