...
export const AGENT_COMMAND_LABEL: Record<
  "REAPPLY_ALIAS" | "REAPPLY_CONFIG" | "UPGRADE_CLIENT" | "UPGRADE_RUSTDESK" | "UPGRADE_AGENT" | "SERVICE_CONTROL" | "ROTATE_TOKEN_REQUIRED",
  string
> = {
  REAPPLY_ALIAS: "Reaplicar alias",
  REAPPLY_CONFIG: "Reaplicar configuracao",
  UPGRADE_CLIENT: "Atualizar cliente",
  UPGRADE_RUSTDESK: "Atualizar RustDesk",
  UPGRADE_AGENT: "Atualizar agente",
