...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      "@dosc-syspro/contracts/evolution-settings": path.resolve(__dirname, "../../packages/contracts/src/evolution/evolution-settings.ts"),
      ...
      "@dosc-syspro/contracts/platform-notifications": path.resolve(__dirname, "../../packages/contracts/src/shared/platform-notifications.ts"),
      ...
      "@dosc-syspro/contracts/address": path.resolve(__dirname, "../../packages/contracts/src/shared/address.ts"),
      "@dosc-syspro/contracts/documento": path.resolve(__dirname, "../../packages/contracts/src/documento/documento.ts"),
      "@dosc-syspro/contracts/documento-config": path.resolve(__dirname, "../../packages/contracts/src/documento/documento-config.ts"),
