...
<Callout title="Informacao complementar sugerida">
  ...
  {' '}[GTA]. Operacao de remessa para abate/industrializacao, com posterior
...
<Callout title="Informacao complementar sugerida">
  ...
  produtor [NOME/CPF], acompanhada da GTA no [GTA]. Documento emitido para
  acobertar a entrada fiscal da operacao, conforme orientacao fiscal aplicavel.
</Callout>
...
<Callout title="Informacao complementar sugerida">
  ...
  a NF-e no [NF_ORIGEM], serie [SERIE], emitida em [DATA], vinculada a GTA no
  {' '}[GTA]. Operacao de retorno dos produtos resultantes do
...
<Callout title="Informacao complementar sugerida">
  ...
  {' '}[NF_ORIGEM], serie [SERIE], e a GTA no [GTA].
</Callout>
...
<Callout title="Informacao complementar sugerida">
  ...
  legislacao aplicavel. CST [CST]. Produto oriundo de processo de
  abate/industrializacao.
</Callout>
