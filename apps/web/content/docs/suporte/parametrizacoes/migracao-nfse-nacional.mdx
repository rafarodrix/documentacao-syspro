...
No módulo **PERSONALIZAÇíO DE DOCUMENTO**, localize as opções **EVD**, **EVP** E **ENP** e ajuste a série da NFSe para **01**.
...
2. Marque **NíO** no campo **Enviar IM**.
...
No módulo **TRIBUTAÇíO**, aplique a regra de que o NBS está para o serviço assim como o NCM está para o produto.
