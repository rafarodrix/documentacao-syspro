...
description: PostgreSQL via Prisma ORM agrupamento por domínio de todos os modelos, enums principais e convenções do schema do Trilink Portal.
...
4. `AuthorizationService` resolve permissÃµes globais e por empresa a partir desses vínculos
...
RemoteHost
  ...
  ├── RemoteSession[]        (histórico de sessÃµes)
