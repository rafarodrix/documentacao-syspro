---
title: "Guia: Como criar um novo package no monorepo"
description: Passo a passo para criar um novo package interno no monorepo — quando criar, estrutura de arquivos, TypeScript config e registro como workspace.
...
{
  "dependencies": {
    "@dosc-syspro/<nome>": "file:../../packages/<nome>"
  }
}
```
...
- [ ] Adicionado nos consumers com o mesmo padrão usado no workspace
- [ ] `npm install` executado na raiz
- [ ] README com propósito e exports
- [ ] Documentação interna atualizada em `apps/web/content/docs/admin/documentacao-portal/`
