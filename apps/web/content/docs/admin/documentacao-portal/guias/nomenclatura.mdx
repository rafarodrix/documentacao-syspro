---
title: "Guia: Padrão de Nomenclatura"
description: Convenções de nomes adotadas no monorepo — TypeScript, Go, banco de dados Prisma, rotas REST e packages internos.
...
| Nome de diretório     | `kebab-case`           | `packages/features/remote/domain/`        |
