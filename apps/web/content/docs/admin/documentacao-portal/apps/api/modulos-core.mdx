...
Sistema de chamados técnicos internos. Usa o modelo `Conversation { channel: PORTAL }` do banco — ver nota sobre nomenclatura em `apps/tickets-architecture`.
...
**Documentação completa:** `/portal/docs/admin/documentacao-portal/apps/tickets-architecture`
