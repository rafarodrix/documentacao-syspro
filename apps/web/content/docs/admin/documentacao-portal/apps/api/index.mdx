---
title: app/api — Backend NestJS
description: O apps/api é o backend principal do Trilink Portal, expondo tRPC para o frontend e REST para webhooks e o agente Go.
...
- [Fluxos empresa, usuarios e contatos](/portal/docs/admin/documentacao-portal/apps/api/empresa-usuarios-contatos): relacionamento real entre `companies`, `contacts`, `users`, `Membership` e `UserContactLink`.
