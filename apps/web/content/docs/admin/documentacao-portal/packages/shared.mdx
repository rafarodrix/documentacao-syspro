---
title: "Package: @dosc-syspro/shared"
description: Funções utilitárias compartilhadas — formatadores, logger estruturado, auth HMAC, rate limiting e status operacional remoto.
