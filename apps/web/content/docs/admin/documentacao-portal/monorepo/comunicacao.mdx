---
title: Comunicação entre Apps
description: Diagrama geral
...
→ body: { schemaVersion, discoveryToken, rustdeskId, machineName, ... }
...
→ body: { installToken, rustdeskId, machineName, ... }
