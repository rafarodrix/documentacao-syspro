...
- **Frontend**: `apps/web` em **Vercel**
- **Backend**: `apps/api` (Nest) em **Railway** (migracao em andamento)
...
- **Zammad**: hospedado na Contabo em **outra VPS** (isolada da stack RustDesk/Evolution)
...
- `suporte.<dominio>` -> Zammad (VPS Contabo dedicada do Zammad)
...
2. Backend Nest orquestra Zammad + Evolution.
