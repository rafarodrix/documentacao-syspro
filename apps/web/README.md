...
- adapters remotos passaram a ser consumidos via `packages/remote-infra`, e não mais direto de `packages/api`
...
- `packages/api`: routers e superfície de aplicação/backend
