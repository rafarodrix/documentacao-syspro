...
export function GetAgentSetupView() {
  return window['go']['uiwails']['API']['GetAgentSetupView']();
}

export function GetAgentSupportView() {
  return window['go']['uiwails']['API']['GetAgentSupportView']();
}
