...
export class UsersController {
  ...
  create(
    @Req() req: Request,
    @Body() body: { email: string; name: string; password?: string; role?: Role; companyId?: string; additionalCompanyIds?: string[]; cpf?: string; jobTitle?: string; phone?: string },
  ) {
  ...
  update(
    @Req() req: Request,
    @Param('id') id: string,
    @Body() body: { name?: string; email?: string; role?: Role; companyId?: string; additionalCompanyIds?: string[]; isActive?: boolean; cpf?: string; jobTitle?: string; phone?: string },
  ) {
