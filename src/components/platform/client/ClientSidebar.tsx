...
// Itens de menu específicos para o Cliente
const navItems = [
    { title: "Visão Geral", href: "/client", icon: LayoutDashboard },
    { title: "Meus Chamados", href: "/client/chamados", icon: Ticket },
    // Exemplo: Se você tiver área financeira no futuro
    // { title: "Faturas", href: "/client/faturas", icon: CreditCard }, 
            ...
            <div className="flex h-full max-h-screen flex-col gap-2">
                ...
                <div className="flex-1 overflow-auto py-2">
                    <nav className="grid items-start px-2 text-sm font-medium lg:px-4 gap-1">
                        ...
                        {/* Link para voltar para a Documentação Pública */}
                        <Link
                            href="/docs"
