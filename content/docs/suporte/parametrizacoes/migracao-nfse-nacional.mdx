...
Acesse o módulo **USUÁRIO** e libere o acesso ao **Grupo de Serviço** e ao **Grupo NBS** (dentro da categoria Produtos)[cite: 1, 2].
</Step>
<Step>
### Ajuste de Documento
No módulo **DOCUMENTO**, localize as opções **EVD** e **EVP** e ajuste a série da NFSe para **01**[cite: 3, 4].
</Step>
<Step>
### Saneamento de Cadastros de Participantes

No módulo **PARTICIPANTE**, verifique a existência de CEPs genéricos (ex: 38300-000)[cite: 5, 6].

- Utilize o seguinte comando para identificar registros: `SELECT * FROM PARTICIPANTE_END PE WHERE PE.CEP = '38300-000';`[cite: 7].
- Caso existam muitos registros, execute o script de atualização para vincular o CEP do participante ao CEP da empresa[cite: 8, 9]:
