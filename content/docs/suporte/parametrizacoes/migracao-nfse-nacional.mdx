...
<Cards>
  <Card title="Webservice Nacional" icon={<Globe />}>
    Define que a transmissão dos dados será direcionada ao servidor unificado
    nacional, em vez do municipal.
  </Card>
  <Card title="Série 01" icon={<Hash />}>
    A série obrigatória para a emissão no padrão nacional, aplicada aos modelos
    EVD e EVP.
  </Card>
  <Card title="Grupo NBS" icon={<FileText />}>
    Nomenclatura Brasileira de Serviços; funciona para serviços assim como o NCM
    funciona para produtos físicos.
  </Card>
  <Card title="Enviar IM" icon={<Building />}>
    Campo que deve ser marcado como "NÃO" para evitar conflitos com a Inscrição
    Municipal no novo layout.
  </Card>
</Cards>
...
Acesse o módulo **USUÁRIO** e libere o acesso ao **Grupo de Serviço** e ao **Grupo NBS** (dentro da categoria Produtos).
...
No módulo **DOCUMENTO**, localize as opções **EVD** e **EVP** e ajuste a série da NFSe para **01**.
